...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/PicInfo/pidSearch');?>" method='post'>
					<p>
					    请输入影像号&nbsp;:&nbsp;<input type='text' name='pid'>
				     &nbsp;&nbsp;时期&nbsp;:&nbsp;<select name='time'>
				                    <option value="">===请选择时期===</option>
					                <option value='ex'>术前</option>
					                <option value='sx'>术后</option>
				                </select>
				    </p>
					<div>
			...
			<div class='content'>
				  ...
				  <table    cellspacing="0" cellpadding="0">
					  <?php if(is_array($pidInfo)): foreach($pidInfo as $key=>$v): ?><tr>
	                         <td style='background:#FFE4C4' align="center"><font face="arial" color="#0000CD">第<?php echo ($v['bid']); ?>位病人<font color="red"><?php echo ($spe); ?></font>的第<font color="red"><?php echo ($v['id']); ?></font>张影像&nbsp;&nbsp;:</td>
	                         <td><img  id="img_url" src="<?php echo ($v['smPath']); ?>"></td>
	                         <td style='background:#FFE4C4' align="center"><a href="javascript:void(0);"  onclick="cut_pic();"><font face="arial" color="#0000CD">[查看更多效果]</font></a></td>
	                         <script type="text/javascript">
								   ...
								   function cut_pic(){
							        ...
							        layer.open({
							            ...
							            fixed: false, //不固定
							            maxmin: true,
							            content: '__PUBLIC__/cut.html#'+pic
							        });
							    }
