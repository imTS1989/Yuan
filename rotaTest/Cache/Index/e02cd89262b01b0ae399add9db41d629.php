...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/CtImgInfo/dateSearch');?>" method='post'>
					<p>
					    请输入CT影像时间&nbsp;:&nbsp;<input type='text' name='ct_time'><br/> 
				    </p>
					<div>
			...
			<div class='content'>
				<?php if(is_array($ct_timeInfo)): foreach($ct_timeInfo as $key=>$v): ?><table   border='2px'  bordercolor="blue" cellspacing="0" cellpadding="0">
					  <tr>
					    <th>影像号</th>
					    <th>姓名</th>
					    <th>性别</th>
				     ...
				     <?php if(is_array($ct_timeInfo)): foreach($ct_timeInfo as $key=>$v): ?><tr>
				          ...
				          <td style='background:#F0FFFF'><?php echo ($v["ct_time"]); ?></td>   
				          <td style='background:#F0FFFF'><?php echo ($v["ct_content"]); ?></td>   
				          <td style='background:#F0FFFF'><?php echo ($v["part"]); ?></td>   
				          <td style='background:#F0FFFF'><?php echo ($v["set_num"]); ?></td>   
				          <td style='background:#F0FFFF'><?php echo ($v["remark"]); ?></td>   
	...
	<!--主体右侧-->
		<div class='main-right'>
			<img src='__PUBLIC__/Images/logo.png' width='300' height='380'>
		</div>
	</div>
<!--底部-->
	<div class='bottom'>
