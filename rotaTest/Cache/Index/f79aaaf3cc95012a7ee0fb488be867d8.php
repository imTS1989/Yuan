...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/PicInfo/nameSearch');?>" method='post'>
					<p>
					    请输入病人姓名&nbsp;:&nbsp;<input type='text' name='name'>&nbsp;&nbsp;&nbsp;<input type='radio' name='radio' value='男'>男&nbsp;&nbsp;<input type='radio' name='radio' value='女'>女
				     &nbsp;&nbsp;时期&nbsp;:&nbsp;<select name='time'>
			...
			<div class='content'>
				  ...
				  <table   border='2px' width="520" height="400" bordercolor="blue" cellspacing="0" cellpadding="0">
					  <?php if(is_array($nameInfo)): foreach($nameInfo as $key=>$v): ?><tr>
	                         <td style='background:#FFE4C4'>这是第<?php echo ($v['bid']); ?>位病人<?php echo ($spe); ?>的第<?php echo ($v['id']); ?>张影像&nbsp;&nbsp;:</td>
