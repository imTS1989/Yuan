...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/BaInfo/ageSearch');?>" method='post'>
					<p>
					    请输入病人年龄&nbsp;:&nbsp;<input type='text' name='age'>&nbsp;&nbsp;&nbsp;<input type='radio' name='radio' value='男'>男&nbsp;&nbsp;<input type='radio' name='radio' value='女'>女
				    </p>
					<div>
			...
			<div class='content'>
				<?php if(is_array($ageInfo)): foreach($ageInfo as $key=>$v): ?><table   border='2px' width="520" height="400" bordercolor="blue" cellspacing="0" cellpadding="0">
					  <tr>
