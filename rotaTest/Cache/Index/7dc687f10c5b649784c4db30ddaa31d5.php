...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/TumInfo/nameSearch');?>" method='post'>
					<p>
					    请输入病人姓名&nbsp;:&nbsp;<input type='text' name='name'><br/> 
				    </p>
					<div>
			...
			<div class='content'>
				<?php if(is_array($nameInfo)): foreach($nameInfo as $key=>$v): ?><table   border='2px' width="520" height="400" bordercolor="blue" cellspacing="0" cellpadding="0">
					  <tr>
