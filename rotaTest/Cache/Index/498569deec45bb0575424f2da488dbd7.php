...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/BaInfo/dateSearch');?>" method='post'>
					<p>
					    请输入手术/病理日期&nbsp;:&nbsp;<input type='text' name='pathoDate'><br/> 
				    </p>
					<div>
			...
			<div class='content'>
				<?php if(is_array($pathoDateInfo)): foreach($pathoDateInfo as $key=>$v): ?><table   border='2px' width="520" height="400" bordercolor="blue" cellspacing="0" cellpadding="0">
					  <tr>
