...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/BaInfo/pidSearch');?>" method='post'>
					<p>
			...
			<div class='content'>
				<?php if(is_array($baInfo)): foreach($baInfo as $key=>$v): ?><table   border='2px' width="520" height="400" bordercolor="blue" cellspacing="0" cellpadding="0">
					  <tr>
