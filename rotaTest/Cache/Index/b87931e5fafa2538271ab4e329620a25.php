...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/CtImgInfo/pidSearch');?>" method='post'>
					<p>
			...
			<div class='content'>
				<?php if(is_array($ctImgInfo)): foreach($ctImgInfo as $key=>$v): ?><table   border='2px' width="520" height="400" bordercolor="blue" cellspacing="0" cellpadding="0">
					  <tr>
					  ...
					  <tr>
					    <td align='right' style='background:#FFE4C4'>术前CT时间&nbsp;:&nbsp;</td>
