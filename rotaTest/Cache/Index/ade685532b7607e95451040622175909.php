...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/TumInfo/pidSearch');?>" method='post'>
					<p>
			...
			<div class='content'>
				<?php if(is_array($tumInfo)): foreach($tumInfo as $key=>$v): ?><table   border='2px' width="520" height="400" bordercolor="blue" cellspacing="0" cellpadding="0">
					  <tr>
					  ...
					  <tr>
					    <td align='right' style='background:#FFE4C4'>SCC(ug/ml)&nbsp;:&nbsp;</td>
					  ...
					  <tr>
					   ...
					   <tr>
					    <td align='right' style='background:#FFE4C4'>CA125&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["ca125"]); ?></td>
					  </tr>
					   <tr>
					    <td align='right' style='background:#FFE4C4'>NSE&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["nse"]); ?></td>
					  </tr>
