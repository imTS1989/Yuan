...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/LnodInfo/pidSearch');?>" method='post'>
					<p>
					    请输入影像号&nbsp;:&nbsp;<input type='text' name='pid'><br/> 
				    </p>
					<div>
			...
			<div class='content'>
				  ...
				  <table  width="520" height="400" border='2px'  bordercolor="blue" cellspacing="0" cellpadding="0">
					  <tr>
					    ...
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($baInfo[0]['pid']); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>姓名&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($baInfo[0]['name']); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>性别&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($baInfo[0]['sex']); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>年龄&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($baInfo[0]['age']); ?></td>
					  </tr>
			     <?php if(is_array($lNodInfo)): foreach($lNodInfo as $key=>$v): ?><tr>
					    <td align='right' style='background:#FFE4C4'>位置信息&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["loc"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>结节编号&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["nodNum"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>PIX_X&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["pix_x"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>PIX_Y&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["pix_y"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>PIX_Z&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["pix_z"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>POS_Z&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["pos_z"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>直径&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["diam"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>密度类型&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["denTyp"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>位置类型&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["posTyp"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>病理类型&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["pathoTyp"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>良恶性&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["isBenign"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>TNM分期&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["TNM"]); ?></td>
					  </tr>
					  <tr>
					    <td align='right' style='background:#FFE4C4'>临床分期&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($v["clinTim"]); ?></td>
					  </tr>
					  <tr>
