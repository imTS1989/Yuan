...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			...
			<div class="title">
			  <form action="<?php echo U('Index/MixInfo/pidSearch');?>" method='post'>
					<p>
					    肺结节信息显示&nbsp;:&nbsp; 
				    </p>
					<div>
						<span class='fl'>数据创建于：2018年3月1日</span>
						<span class='fr'><a href="<?php echo U('Index/MixInfo/addPid');?>">返回上一层</a></span>
					</div>
			  </form>
			</div>
			<div class='content'>
				
				  <table  class='table' border='2px' width="520" height="400" bordercolor="blue" cellspacing="0" cellpadding="0">
					  <tr>
					    <td align='right' style='background:#FFE4C4'>影像号&nbsp;:&nbsp;</td>
					    <td align='left' style='background:#F0FFFF'>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($lnod[0]['pid']); ?></td>
					  </tr>
					  <?php if(is_array($lnod)): foreach($lnod as $key=>$v): ?><tr>
						    <td align='right' style='background:#FFE4C4'>结节位置&nbsp;:&nbsp;</td>
						  ...
						  <tr>
						    <td align='right' style='background:#FFE4C4'>结节直径&nbsp;:&nbsp;</td>
